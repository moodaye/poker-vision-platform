...
class MouseController:
    ...
    def __init__(self) -> None:
        ...
        self.click_count = 0
        self.minute_start_time: float = time.time()
    ...
    def click_multiple_buttons(
        self,
        button_locations: list[tuple[int, int, float]],
        max_clicks: int = 1,
    ) -> int:
        """
    ...
    def _check_rate_limit(self) -> bool:
        ...
        return bool(self.click_count < config.MAX_CLICKS_PER_MINUTE)
